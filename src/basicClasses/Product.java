...
public class Product extends Good {
	...
	/* Products are made of 2 Materials: Paint and Stone
	   It can be sold from Selling-Agent to Sales-Market.
	   So it has a Price.
	 */
	...
	public boolean equals(Object o) {
		...
		if (this.stone.getSize() == product.stone.getSize() &&
				product.paint.getColor().equals(this.paint.getColor()))
			return true;
