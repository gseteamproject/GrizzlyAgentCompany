...
public class Procurement extends Agent {
    ...
    // class ProcurementResponder extends AchieveREResponder {
    //
    // /**
    // *
    // */
    ...
    //
    // public ProcurementResponder(Agent a, MessageTemplate mt) {
    // super(a, mt);
    // }
    //
    // @Override
    ...
    // System.out.println("ProcurementAgent: [request] ProductionAgent asks for
    // materials for " + orderText);
    // System.out.println(
    // "ProcurementAgent: [agree] I will check materialStorage for materials for " +
    // orderText);
    // addBehaviour(new CheckMaterialStorage(myAgent, agree));
    // } else if (request.getConversationId() == "Take") {
    // System.out.println("ProcurementAgent: [request] ProductionAgent wants to get
    // materials for " + orderText
    // + " from materialStorage");
    // System.out.println("ProcurementAgent: [agree] I will give you materials for "
    // + orderText
    // + " from materialStorage");
    ...
    //
    // System.out.println("ProcurementAgent: send info to ProcurementMarket to buy
    // materials for "
    ...
    // System.out.println(
    // "ProcurementAgent: Sending an info to ProcurementMarket to buy materials for
    // " + orderText);
    //
    // for (OrderPart orderPart : order.orderList) {
    ...
    // List<AID> agents = ProcurementMarket.findAgents(myAgent,
    // orderPart.getPart().getClass().getSimpleName());
    // if (!agents.isEmpty()) {
    // System.out.println("agents providing service are found. trying to get
    // infromation...");
    ...
    // PREPARE_CALL_FOR_PROPOSAL, HANDLE_CALL_FOR_PROPOSAL_REPLY,
    // PREPARE_ACCEPT_PROPOSAL, HANDLE_ACCEPT_PROPOSAL_REPLY, DONE
    // };
    ...
    //
    // replyTemplate =
    // MessageTemplate.and(MessageTemplate.MatchConversationId("buying"),
    ...
    // orderText = order.getTextOfOrder();
    // System.out.println("ProcurementAgent: Taking " + orderText + " from
    // materialStorage");
    //
